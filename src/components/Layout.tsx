  ...
  return (
    <>
      <div className="flex flex-col justify-start p-0">
        ...
        <div className="bg-[#091144] pt-12 lg:pt-16 bg-gradient-to-r from-[#04041F] from-10% via-[#091144] via-30% to-[#04041F] to-90% flex-1 text-white border-1  border-dashed">
          {children}
          <Footer/>
        </div>
