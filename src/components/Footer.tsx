    ...
    return (
      <footer className="bg-darkblue text-white p-6 text-start">
        ...
        <div className="flex flex-col gap-4 w-full">
         ...
         <div>
         <p className="text-sm">
            GET STARTED TO GROW & TRADE IN THE 
          </p>
          <p className="text-sm">
          BEST MARKETPLACE ON INJECTIVE.
          </p>
         </div>
        ...
        <div className="flex justify-end items-center w-full">
          <Button className="border border-bordercolor shadow-sm shadow-white">Connect Wallet</Button>
        </div>
        </div>
        <div className="mt-6 border-t border-white/20 pt-4">

          <div className="flex justify-end gap-6 mt-2">
          <div> <p className="text-xs">© 2024 INTELYTICS INC.</p></div>
